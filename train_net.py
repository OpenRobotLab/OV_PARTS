...
# MaskFormer
from baselines import add_mask_former_config, SemanticSegmentorWithTTA
...
# from baselines.utils.events import WandbWriter, setup_wandb
...
class Trainer(DefaultTrainer):
    ...
    def build_train_loader(cls, cfg):
        ...
        if cfg.INPUT.DATASET_MAPPER_NAME == "obj_part_semantic":
